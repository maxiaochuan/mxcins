...
import type { BreakpointRecord } from './_libs/MxRC__Libs__Utils.gen'
...
type spacing = number | Partial<BreakpointRecord>

declare interface RowProps extends _RowProps<spacing | [spacing] | [spacing, spacing]> {}
